...
impl<T: Div<Output = T> + Clone> Div<T> for Matrix4x4<T> {
...
impl<T: Div<Output = T>> Div for Matrix4x4<T> {
    type Output = Matrix4x4<T>;
...
impl<T: DivAssign + Clone> DivAssign<T> for Matrix4x4<T> {
...
impl<T: DivAssign> DivAssign for Matrix4x4<T> {
