...
impl<T: Add<Output = T> + Clone> Add<T> for Matrix4x4<T> {
...
impl<T: Add<Output = T>> Add for Matrix4x4<T> {
    type Output = Matrix4x4<T>;
...
impl<T: AddAssign + Clone> AddAssign<T> for Matrix4x4<T> {
...
impl<T: AddAssign> AddAssign for Matrix4x4<T> {
