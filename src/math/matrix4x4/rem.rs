...
impl<T: Rem<Output = T> + Clone> Rem<T> for Matrix4x4<T> {
...
impl<T: Rem<Output = T>> Rem for Matrix4x4<T> {
    type Output = Matrix4x4<T>;
...
impl<T: RemAssign + Clone> RemAssign<T> for Matrix4x4<T> {
...
impl<T: RemAssign> RemAssign for Matrix4x4<T> {
